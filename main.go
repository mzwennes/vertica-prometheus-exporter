...
func main() {
	...
	dbUsername := flag.String("user", "dbadmin", "Vertica username")
	dbPassword := flag.String("password", "dbadmin", "Vertica password")
	dbHost := flag.String("host", "localhost", "Vertica hostname")
	dbPort := flag.Int("port", 5433, "Vertica port")
	dbName := flag.String("database", "vertica", "Vertica database name")
	flag.Parse()
